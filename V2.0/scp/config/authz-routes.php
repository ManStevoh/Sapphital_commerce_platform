...
return [
    ...
    'identity.auth.customer.register' => ['method' => 'POST', 'uri' => '/api/v1/auth/customer/register', 'archetype' => 'tenant'],
    'identity.auth.customer.login' => ['method' => 'POST', 'uri' => '/api/v1/auth/customer/login', 'archetype' => 'tenant'],
    'identity.auth.customer.logout' => ['method' => 'POST', 'uri' => '/api/v1/auth/customer/logout', 'archetype' => 'sanctum'],
    ...
    'account.orders.index' => ['method' => 'GET', 'uri' => '/api/v1/commerce/account/orders', 'archetype' => 'sanctum'],
    'account.addresses.index' => ['method' => 'GET', 'uri' => '/api/v1/commerce/account/addresses', 'archetype' => 'sanctum'],
    'account.addresses.store' => ['method' => 'POST', 'uri' => '/api/v1/commerce/account/addresses', 'archetype' => 'sanctum'],
    'account.addresses.destroy' => ['method' => 'DELETE', 'uri' => '/api/v1/commerce/account/addresses/00000000-0000-4000-8000-000000000001', 'archetype' => 'sanctum'],
    ...
    'ops.status.show' => ['method' => 'GET', 'uri' => '/api/v1/status', 'archetype' => 'public'],
    'ops.runbooks.index' => ['method' => 'GET', 'uri' => '/api/v1/ops/runbooks', 'archetype' => 'public'],
    'ops.support-macros.index' => ['method' => 'GET', 'uri' => '/api/v1/support/macros', 'archetype' => 'public'],
    ...
    'catalog.search.autocomplete' => ['method' => 'GET', 'uri' => '/api/v1/commerce/catalog/search/autocomplete?q=shi', 'archetype' => 'tenant'],
