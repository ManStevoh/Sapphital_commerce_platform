...
final class OrderIsolationTest extends PlatformTestCase
{
    private const MODEL_CLASS = \Modules\Commerce\Orders\Models\Order::class;
    ...
    public function test_alpha_cannot_select_beta_row_via_rls(): void
    {
        ...
        [$alpha, $beta] = IsolationContext::twoTenants('Order');
    ...
    public function test_alpha_cannot_update_beta_row_via_rls(): void
    {
        ...
        [$alpha, $beta] = IsolationContext::twoTenants('Order-upd');
        $betaRecord = (new IsolationRecordFactory)->create(self::MODEL_CLASS, $beta->id);
        $table = $betaRecord->getTable();
    ...
    public function test_alpha_cannot_delete_beta_row_via_rls(): void
    {
        ...
        [$alpha, $beta] = IsolationContext::twoTenants('Order-del');
        $betaRecord = (new IsolationRecordFactory)->create(self::MODEL_CLASS, $beta->id);
        $table = $betaRecord->getTable();
    ...
    {
        [$alpha, $beta] = IsolationContext::twoTenants('Order-eloq');
        $betaRecord = (new IsolationRecordFactory)->create(self::MODEL_CLASS, $beta->id);
