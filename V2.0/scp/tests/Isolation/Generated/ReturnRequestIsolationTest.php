...
final class ReturnRequestIsolationTest extends PlatformTestCase
{
    private const MODEL_CLASS = \Modules\Commerce\Orders\Models\ReturnRequest::class;
    ...
    public function test_alpha_cannot_select_beta_row_via_rls(): void
    {
        ...
        [$alpha, $beta] = IsolationContext::twoTenants('ReturnRequest');
    ...
    public function test_alpha_cannot_update_beta_row_via_rls(): void
    {
        ...
        [$alpha, $beta] = IsolationContext::twoTenants('ReturnRequest-upd');
        $betaRecord = (new IsolationRecordFactory)->create(self::MODEL_CLASS, $beta->id);
        $table = $betaRecord->getTable();
    ...
    public function test_alpha_cannot_delete_beta_row_via_rls(): void
    {
        ...
        [$alpha, $beta] = IsolationContext::twoTenants('ReturnRequest-del');
        $betaRecord = (new IsolationRecordFactory)->create(self::MODEL_CLASS, $beta->id);
        $table = $betaRecord->getTable();
    ...
    {
        [$alpha, $beta] = IsolationContext::twoTenants('ReturnRequest-eloq');
        $betaRecord = (new IsolationRecordFactory)->create(self::MODEL_CLASS, $beta->id);
