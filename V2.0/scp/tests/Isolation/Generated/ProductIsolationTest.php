...
final class ProductIsolationTest extends PlatformTestCase
{
    private const MODEL_CLASS = \Modules\Commerce\Catalog\Models\Product::class;
    ...
    public function test_alpha_cannot_select_beta_row_via_rls(): void
    {
        ...
        [$alpha, $beta] = IsolationContext::twoTenants('Product');
    ...
    public function test_alpha_cannot_update_beta_row_via_rls(): void
    {
        ...
        [$alpha, $beta] = IsolationContext::twoTenants('Product-upd');
        $betaRecord = (new IsolationRecordFactory)->create(self::MODEL_CLASS, $beta->id);
        $table = $betaRecord->getTable();
    ...
    public function test_alpha_cannot_delete_beta_row_via_rls(): void
    {
        ...
        [$alpha, $beta] = IsolationContext::twoTenants('Product-del');
        $betaRecord = (new IsolationRecordFactory)->create(self::MODEL_CLASS, $beta->id);
        $table = $betaRecord->getTable();
    ...
    {
        [$alpha, $beta] = IsolationContext::twoTenants('Product-eloq');
        $betaRecord = (new IsolationRecordFactory)->create(self::MODEL_CLASS, $beta->id);
