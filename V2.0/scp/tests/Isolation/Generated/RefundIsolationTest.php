...
final class RefundIsolationTest extends PlatformTestCase
{
    private const MODEL_CLASS = \Platform\FinancialServices\Models\Refund::class;
    ...
    public function test_alpha_cannot_select_beta_row_via_rls(): void
    {
        ...
        [$alpha, $beta] = IsolationContext::twoTenants('Refund');
    ...
    public function test_alpha_cannot_update_beta_row_via_rls(): void
    {
        ...
        [$alpha, $beta] = IsolationContext::twoTenants('Refund-upd');
        $betaRecord = (new IsolationRecordFactory)->create(self::MODEL_CLASS, $beta->id);
        $table = $betaRecord->getTable();
    ...
    public function test_alpha_cannot_delete_beta_row_via_rls(): void
    {
        ...
        [$alpha, $beta] = IsolationContext::twoTenants('Refund-del');
        $betaRecord = (new IsolationRecordFactory)->create(self::MODEL_CLASS, $beta->id);
        $table = $betaRecord->getTable();
    ...
    {
        [$alpha, $beta] = IsolationContext::twoTenants('Refund-eloq');
        $betaRecord = (new IsolationRecordFactory)->create(self::MODEL_CLASS, $beta->id);
