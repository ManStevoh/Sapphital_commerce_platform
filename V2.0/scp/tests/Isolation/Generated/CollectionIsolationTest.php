...
final class CollectionIsolationTest extends PlatformTestCase
{
    private const MODEL_CLASS = \Modules\Commerce\Catalog\Models\Collection::class;
    ...
    public function test_alpha_cannot_select_beta_row_via_rls(): void
    {
        ...
        [$alpha, $beta] = IsolationContext::twoTenants('Collection');
    ...
    public function test_alpha_cannot_update_beta_row_via_rls(): void
    {
        ...
        [$alpha, $beta] = IsolationContext::twoTenants('Collection-upd');
        $betaRecord = (new IsolationRecordFactory)->create(self::MODEL_CLASS, $beta->id);
        $table = $betaRecord->getTable();
    ...
    public function test_alpha_cannot_delete_beta_row_via_rls(): void
    {
        ...
        [$alpha, $beta] = IsolationContext::twoTenants('Collection-del');
        $betaRecord = (new IsolationRecordFactory)->create(self::MODEL_CLASS, $beta->id);
        $table = $betaRecord->getTable();
    ...
    {
        [$alpha, $beta] = IsolationContext::twoTenants('Collection-eloq');
        $betaRecord = (new IsolationRecordFactory)->create(self::MODEL_CLASS, $beta->id);
